...
class AlignDlib:
    ...
    def getLargestFaceBoundingBox(self, rgbImg):
        ...
        :rtype: dlib.rectangle # left,top,right,bottom
        """
        assert rgbImg is not None
    ...
    def align(self, imgDim, rgbImg, bb=None,
        ...
        :param down_rate: pull the template face down a certain distance, 'dow_rate' * its length
        :type down_rate: float
        ...
        # MINMAX_TEMPLATE所有值在(0,1)直接，用(x,y)坐标表示，x表示横坐标，y表示纵坐标
        # 下面的代码等价于
        # MINMAX_TEMPLATE[:,1]+=down_rate #坐标变为原来的(1+down_rate)倍
